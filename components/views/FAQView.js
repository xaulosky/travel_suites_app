        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden hover:shadow-md transition-shadow">
            <button onclick="toggleFAQ(${idx})" class="w-full p-5 flex items-start gap-4 text-left hover:bg-slate-50 transition-colors">
                ...
                <div class="flex-shrink-0">
                    <svg id="faq-icon-${idx}" class="w-5 h-5 text-slate-400 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                </div>
            </button>
            <div id="faq-answer-${idx}" class="hidden px-5 pb-5 pl-16 border-t border-slate-100">
                <div class="pt-4">
                    ${faq.answer}
                </div>
            </div>
    ...
    return `
        <div class="flex flex-col h-full">
            <div class="bg-slate-900 p-4 md:p-6 sticky top-0 z-10 shadow-lg md:rounded-b-2xl">
                ...
                <p class="text-slate-400 text-sm">Guías de solución de problemas y políticas</p>
            </div>
